    ...
    <div className="grid grid-cols-1 gap-4">
      ...
      <div className="bg-white rounded-2xl p-5 border border-slate-100 shadow-sm">
        <div className="flex items-center gap-2 mb-4">
          <Flame className="text-orange-500 fill-orange-500/10" size={20} />
          <h2 className="font-bold text-slate-800 text-lg">{t('summary.title')}</h2>
        </div>

        <div className="flex justify-between items-end mb-6">
          <div className="text-center">
            <div className="text-2xl font-bold text-slate-900 mb-1">{Math.round(totals.calories)}</div>
            <div className="text-slate-500 text-xs font-medium">Food</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-slate-300 mb-1">0</div>
            <div className="text-slate-400 text-xs font-medium">Exercise</div>
          </div>
          <div className="text-center">
            <div className={`text-2xl font-bold mb-1 ${remaining >= 0 ? 'text-emerald-500' : 'text-red-500'}`}>
              {Math.round(remaining)}
            </div>
            <div className="text-slate-500 text-xs font-medium">Remaining</div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl p-5 border border-slate-100 shadow-sm text-slate-900">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="font-bold text-slate-800 text-lg">Macros</h2>
        </div>
          ...
          <div>
            <div className="flex justify-between text-sm mb-1">
              <div className="font-medium text-slate-900">
                ...
                <span className="text-slate-400">/{dailyGoals.carbs}</span>
              </div>
              <div className="text-slate-500">{t('detail.carbs')} (g)</div>
            </div>
          ...
          <div>
            <div className="flex justify-between text-sm mb-1">
              <div className="font-medium text-slate-900">
                ...
                <span className="text-slate-400">/{dailyGoals.protein}</span>
              </div>
              <div className="text-slate-500">{t('detail.protein')} (g)</div>
            </div>
            <div className="h-1.5 bg-slate-100 rounded-full overflow-hidden">
              <div
          ...
          <div>
            <div className="flex justify-between text-sm mb-1">
              <div className="font-medium text-slate-900">
                ...
                <span className="text-slate-400">/{dailyGoals.fat}</span>
              </div>
              <div className="text-slate-500">{t('detail.fat')} (g)</div>
            </div>
            <div className="h-1.5 bg-slate-100 rounded-full overflow-hidden">
              <div
