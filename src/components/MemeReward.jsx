        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-md bg-slate-900 border border-slate-700 rounded-3xl p-6 shadow-2xl animate-scale-up overflow-hidden">
                ...
                <div className="text-center mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-white mb-1">Meal Logged!</h2>
                    <p className="text-slate-400 text-sm">Here's a meme for keeping it real.</p>
                </div>
                ...
                <div className="flex gap-3">
                    <button
                        onClick={onClose}
                        className="flex-1 py-3 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-white font-semibold rounded-xl transition-all active:scale-[0.98] shadow-lg shadow-emerald-500/20"
                    >
                        Awesome!
                    </button>
                </div>
